...
exports.orderProducts = (req, res, next) => {
  Cartinfo.find({ "sessionInfo.email": req.body.sessionInfo.email }, function(
    err,
    cartDt
  ) {
  ...
  Cartinfo.updateOne(
    {
      ...
      "cartResponse.productId": req.body.id
    },
    {
      $set: {
        "cartResponse.$.qauntity_buy": req.body.qty,
        "cartResponse.$.price_payable": req.body.price * req.body.qty
      }
    }
  ).then(prodLists => {
    res.status(201).json({
